...
export const screens = [
  'home','mainMenu','minigames','gameHome','authRegister','authLogin','profile',
  'friends','requests','setup','join','lobby','prep','reveal','starting','playing',
  'scoring','results','finish','chupisticaSetup','chupisticaWheel','ageSetup',
  'agePreparation','ageReveal','agePlaying','confessionsSetup','confessionsWriting',
  'confessionsVoting','confessionsResults','confessionsScoreboard','chamuyayaHome',
...
export const MINI_GAME_LABELS = {
  age: '🎂 ADIVINA LA EDAD',
  confessions: '🔥 PERDONA NUESTROS PECADOS',
  stop: '🛑 STOP',
  chamuyaya: '🎭 CHAMUYA2',
  tribunal: '🏛️ TRIBUNAL EXPRESS'
};
